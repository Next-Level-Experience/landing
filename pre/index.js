/* Esse arquivo é para que você possa ver como o relógio da página se comporta em diferentes horários.
A live começou às 20hrs. Antes desse horário, o relógio aparecia na tela. Após esse horário, o relógio
foi substituído programaticamente por uma mensagem e um botão de ação. Através desse arquivo você poderá 
determinar diferentes datas e horários e poderá ver como a página fica antes, durante e depois do evento. */
...
let count = 0
let secs = 50 /* Edite esse valor para determinar os segundos iniciais  */
...
const setTimer = setInterval(() => {
    ...
    // Edite qualquer data abaixo para simular um momento específico
    const eventDate = new Date('Nov 26 2020 20:00').getTime()
    const postEvent = new Date('Nov 26 2020 21:00').getTime()
    let now = new Date(`Nov 26 2020 19:59:${secs}`).getTime()
    // Edite qualquer data acima para simular um momento específico
    secs++
